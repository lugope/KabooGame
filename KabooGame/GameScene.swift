...
class GameScene: SKScene {
    override func didMove(to view: SKView) {
        ...
        let opponentCard1 = Card(cardId: 0)
        let opponentCard2 = Card(cardId: 0)
        let opponentCard3 = Card(cardId: 0)
        let opponentCard4 = Card(cardId: 0)
        let opponentCard5 = Card(cardId: 0)
        let opponentCard6 = Card(cardId: 0)
        let opponentCard7 = Card(cardId: 0)
        let opponentCard8 = Card(cardId: 0)
        let opponentCard9 = Card(cardId: 0)
        let opponentCard10 = Card(cardId: 0)
        let opponentCard11 = Card(cardId: 0)
        let opponentCard12 = Card(cardId: 0)
